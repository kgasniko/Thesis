...
\newcommand{\etmiss}{\ensuremath{E_T^{miss}}\xspace}
\newcommand{\wlnu}{\ensuremath{W \to l \nu}\xspace}
\newcommand{\wenu}{\ensuremath{W \to e \nu}\xspace}
\newcommand{\wmunu}{\ensuremath{W \to \mu \nu}\xspace}
\newcommand{\wplusenu}{\ensuremath{W^{+} \to e \nu}\xspace}
\newcommand{\wplusmunu}{\ensuremath{W^+ \to \mu \nu}\xspace}
\newcommand{\ptl}{\ensuremath{P_T^l}\xspace}
\newcommand{\ptcone}{\ensuremath{P_{T}^{cone,20}}}
\newcommand{\etall}{\ensuremath{| \eta^l |}}
\newcommand{\ptw}{\ensuremath{P_T^W}\xspace}
\newcommand{\mtw}{\ensuremath{M_T^W}\xspace}
\newcommand{\chiD}{\ensuremath{\chi^2}\xspace}
\newcommand{\sumet}{\ensuremath{\sum E_T}\xspace}
\newcommand{\uperp}{\ensuremath{u_{\perp}}\xspace}
\newcommand{\upar}{\ensuremath{u_{\parallel}}\xspace}
\newcommand{\cw}{\ensuremath{C_W}\xspace}
